...
public class TestBusinessTagRecorder extends AnalyticsTestSuiteWithEmbeddedDB {
    ...
    public void setUp() throws Exception {
        ...
        final AccountDao accountDao = new DefaultAccountDao(dbi, eventBus, clock, controllerDispatcher, new InternalCallContextFactory(dbi, new ClockMock(), nonEntityDao, controllerDispatcher));
